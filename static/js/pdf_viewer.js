        ...
        function initPDFViewer() {
            ...
            let pdfUrl = `${window.location.origin}/api/paper/${encodeURIComponent(paperId)}/file`;
            
            if (useChinese) {
                pdfUrl = `${window.location.origin}/api/paper/${encodeURIComponent(paperId)}/chinese/file`;
            }
        ...
        function sendReadingTime(seconds, useBeacon = false) {
            ...
            const url = `/api/paper/${encodeURIComponent(paperId)}/read-time`;
            const data = JSON.stringify({ increment: seconds });
            
            // sendBeacon cannot attach the required Authorization header.
            fetch(url, {
                method: 'POST',
