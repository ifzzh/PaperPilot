...
from ipaper.database.db_manager import _ensure_daily_asset_columns
...
def apply(db_path: Path, backup_dir: Path) -> Path:
    ...
    backup = backup_dir / f"ipaper-pre-v0.10.3-{stamp}.db"
    manifest = backup_dir / f"ipaper-v0.10.3-{stamp}.manifest.json"
